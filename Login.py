...
### FUNCTIONS ###
  #           #
    ...
    def checkFields(self):
        ...
        if (textUser + textPassword != ''):
            ...
            with open("database.txt", 'r') as dataBase:
                    for _ in dataBase:
                        if (_ == self.lineEdit_user.text() + self.lineEdit_password.text()):
                            text = "Usuário Reconhecido"
                            showMessage(text)
                            self.pushButton_login.clicked.connect(self.createWindowNew)
                        else:
                            text = "Usuário Desconhecido. Por favor comunicar ao estagiário para realizar registro."
                            showMessage(text)    
    ...
    def setupUi(self, MainWindow):
        ...
        self.imgpjrj = QtWidgets.QLabel(self.login_area)

        self.pj_pixmap = QPixmap("Images/logo_360x90.png")
        self.pixmap_pj_scaled = self.pj_pixmap.scaled(512, 156, QtCore.Qt.KeepAspectRatio)


        self.imgpjrj.setPixmap(self.pixmap_pj_scaled)
        self.imgpjrj.move(60,-15)
        ...
        self.avatar.setStyleSheet("QFrame {\n"
                                  ...
                                  "    border-radius: 60px;\n"
                                  "    border: 10px solid rgb(43, 84, 126);\n"
                                  "    background-position: center;\n"
                                  "}\n"
                                  "QFrame:hover {\n"
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_save_user.setText(_translate("MainWindow", "GUARDAR USUÁRIO"))
        self.pushButton_login.setText(_translate("MainWindow", "Conecte ao Sistema"))
